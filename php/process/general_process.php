...
function display_show($category) {
    global $connect;
    $sql = "SELECT * FROM shows WHERE type = '$category' LIMIT 10";
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        ?>
        <div class="card">
            <a class="text-decoration-none" href="php/pages/card_details.php?id=<?php echo $row['show_id']; ?>">
